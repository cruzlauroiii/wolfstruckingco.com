...
public partial class CaseStudiesPage
{
    ...
    [
        new(Industry1, Customer1, Story1, [new(M1A, M1ALabel), new(M1B, M1BLabel), new(M1C, M1CLabel)]),
        new(Industry2, Customer2, Story2, [new(M2A, M2ALabel), new(M2B, M2BLabel), new(M2C, M2CLabel)]),
    ];
