...
public partial class InvestorsUsersPage
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        Total = Users.Count;
        AdminCount = Users.Count(U => string.Equals(Get(U, FieldRole), RoleAdmin, StringComparison.Ordinal));
        DriverCount = Users.Count(U => string.Equals(Get(U, FieldRole), RoleDriver, StringComparison.Ordinal));
        UserCount = Users.Count(U => string.Equals(Get(U, FieldRole), RoleUser, StringComparison.Ordinal));
    }
