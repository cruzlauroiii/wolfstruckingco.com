...
void Add(string Path, string N) => Out.Add(new JsonObject {
    ["action"] = "navigate",
...
// Seller — lands on home page, signs up, signs in, posts job through agent chat
Add("/",               "Car seller lands on the Wolfs home page.");
Add("/SignUp/",        "Car seller signs up. She runs a car business in Shanghai.");
Add("/Login/",         "Car seller signs in to post a car for sale.");
...
// Drivers — each one signs up, signs in, taps Apply, chats with Agent, uploads docs, then waits
Add("/SignUp/",        "Driver from China signs up.");
Add("/Login/",         "Driver from China signs in.");
...
Add("/SignUp/",        "Driver from Los Angeles signs up.");
Add("/Login/",         "Driver from Los Angeles signs in.");
...
Add("/SignUp/",        "Team driver in Phoenix signs up.");
Add("/Login/",         "Team driver in Phoenix signs in.");
...
Add("/SignUp/",        "Driver in Wilmington signs up.");
Add("/Login/",         "Driver in Wilmington signs in.");
...
Add("/Login/",         "Admin signs in to approve the new drivers.");
...
// Buyer — lands on home, signs up, signs in, browses marketplace, sees the posted car
Add("/",               "Car buyer lands on the Wolfs home page.");
Add("/SignUp/",        "Car buyer signs up. He wants to buy a car.");
Add("/Login/",         "Car buyer signs in to find a car.");
