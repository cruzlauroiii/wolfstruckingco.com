...
Console.WriteLine($"v3-serve capture starting. total scenes={Scenes.GetArrayLength()}");
...
async Task<(bool ok, string? group, string pad)> RunScene(int Idx, JsonElement Scene, string? CurrentGroupIn)
{
    ...
    try
    {
        ...
        if (Pad == "058" || Pad == "059" || Pad == "060" || Pad == "061" || Pad == "062" || Pad == "066" || Pad == "067" || Pad == "068")
        {
        ...
        if (Pad == "063" || Pad == "064" || Pad == "065" || Pad == "069")
        {
