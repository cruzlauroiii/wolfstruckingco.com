...
var MergeGeneric = Read("MergeGeneric");
var MergeConfig = Read("MergeConfig");
var RealPipelineGeneric = Read("RealPipelineGeneric");
var RealPipelineConfig = Read("RealPipelineConfig");
...
if (Repo is null || DiscoverGeneric is null || DiscoverConfig is null || NarrateGeneric is null || NarrateConfig is null || MergeGeneric is null || MergeConfig is null || RealPipelineGeneric is null || RealPipelineConfig is null || TtsGeneric is null || TtsConfig is null || EncodeGeneric is null || EncodeConfig is null || ConcatGeneric is null || ConcatConfig is null) return 3;
...
var E2 = await Step("L3", NarrateGeneric, NarrateConfig); if (E2 != 0) return 11;
var E3 = await Step("M", MergeGeneric, MergeConfig); if (E3 != 0) return 12;
var E4 = await Step("R5", RealPipelineGeneric, RealPipelineConfig); if (E4 != 0) return 13;
var E5 = await Step("L4", TtsGeneric, TtsConfig); if (E5 != 0) return 14;
var E6 = await Step("L5", EncodeGeneric, EncodeConfig); if (E6 != 0) return 15;
var E7 = await Step("L6", ConcatGeneric, ConcatConfig); if (E7 != 0) return 16;
return 0;
