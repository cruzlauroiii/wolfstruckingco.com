...
namespace Scripts
{
    internal static class PubExecPrintBase64Scene004PngTesterConfigV1
    {
        ...
        public const string Config = @"main\scripts\specific\print-base64-scene-004-png-scratch-config-v1.cs";
    }
}
