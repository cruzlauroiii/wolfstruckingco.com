...
namespace Scripts
{
    internal static class DumpFileScratchConfigV217
    {
        public const string Path = @"C:\repo\public\wolfstruckingco.com\main\scripts\specific\dotnet-build-scratch-config.cs";
