...
namespace Scripts
{
    internal static class PubExecKillRebuildWalkthroughV4TesterConfigV1
    {
        ...
        public const string Config = @"main\scripts\specific\kill-by-name-rebuild-walkthrough-v4-scratch-config-v1.cs";
    }
}
