...
namespace Scripts
{
    internal static class DumpFileScratchConfigV225
    {
        public const string Path = @"C:\repo\public\wolfstruckingco.com\main\scripts\specific\patch-source-scratch-config.cs";
