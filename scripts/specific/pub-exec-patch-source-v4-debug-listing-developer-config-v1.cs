...
namespace Scripts
{
    internal static class PubExecPatchSourceV4DebugListingDeveloperConfigV1
    {
        ...
        public const string Config = @"main\scripts\specific\patch-source-v4-debug-listing-scratch-config-v1.cs";
    }
}
