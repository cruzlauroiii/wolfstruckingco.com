...
namespace Scripts
{
    internal static class PubExecPatchSourceV4PidRefreshDeveloperConfigV1
    {
        ...
        public const string Config = @"main\scripts\specific\patch-source-v4-pid-refresh-scratch-config-v1.cs";
    }
}
