...
namespace Scripts
{
    internal static class PubExecPatchSourceV4PreShotLogDeveloperConfigV1
    {
        ...
        public const string Config = @"main\scripts\specific\patch-source-v4-pre-shot-log-scratch-config-v1.cs";
    }
}
