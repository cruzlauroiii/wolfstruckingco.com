...
namespace Scripts
{
    internal static class DumpFileScratchConfigV227
    {
        public const string Path = @"C:\repo\public\wolfstruckingco.com\main\scripts\specific\write-file-scratch-config.cs";
