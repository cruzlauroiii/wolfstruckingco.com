...
namespace Scripts
{
    internal static class PubExecPrintBase64Scene011PngTesterConfigV1
    {
        ...
        public const string Config = @"main\scripts\specific\print-base64-scene-011-png-scratch-config-v1.cs";
    }
}
